...
var iI = (J, Q, D) =>
  Q in J
    ? EI(J, Q, { enumerable: !0, configurable: !0, writable: !0, value: D })
    : (J[Q] = D);
var L = (J, Q, D) => iI(J, typeof Q != 'symbol' ? Q + '' : Q, D);
import { _ as rI } from './chunk-INHXZS53-D3tQiqtZ.js';
var tI =
    (typeof document < 'u' &&
    ...
    (J = {}) => {
      ...
      var m = Object.assign({}, Q),
        U = Q.printErr || console.error.bind(console);
      ...
      function rA() {
        var A = P.buffer;
        (Q.HEAP8 = x = new Int8Array(A)),
          (Q.HEAP16 = T = new Int16Array(A)),
          (Q.HEAPU8 = h = new Uint8Array(A)),
          (Q.HEAPU16 = K = new Uint16Array(A)),
          (Q.HEAP32 = Y = new Int32Array(A)),
          (Q.HEAPU32 = w = new Uint32Array(A)),
          (Q.HEAPF32 = EA = new Float32Array(A)),
          (Q.HEAPF64 = iA = new Float64Array(A));
      }
      var tA = [],
        eA = [],
        oA = [];
      ...
      function mA(A) {
        return Promise.resolve().then(() => {
          if (A == H && X) var I = new Uint8Array(X);
      ...
      function sA(A, I, B) {
        return mA(A)
          .then(g => WebAssembly.instantiate(g, I))
          .then(g => g)
          .then(B, g => {
      ...
      function YA(A, I) {
        ...
        return X ||
          ...
          ? sA(B, A, I)
          : fetch(B, { credentials: 'same-origin' }).then(g =>
              WebAssembly.instantiateStreaming(g, A).then(
                I,
                C => (
                  U(`wasm streaming compile failed: ${C}`),
      ...
      function LA(A, I, B = {}) {
        ...
        if (!A)
          throw new f(
            `type "${g}" must have a positive integer typeid pointer`
          );
        ...
        (S[A] = I),
          delete j[A],
          v.hasOwnProperty(A) && ((I = v[A]), delete v[A], I.forEach(C => C()));
      }
      function N(A, I, B = {}) {
      ...
      var ZA = (A, I) => {
        ...
        AA = (A, I) => Object.defineProperty(I, 'name', { value: A }),
        bA = A => {
          while (A.length) {
            var I = A.pop();
            A.pop()(I);
      ...
      function FA(A) {
        for (var I = 1; I < A.length; ++I)
          if (A[I] !== null && A[I].C === void 0) return !0;
        return !1;
      }
      function TA(A) {
        var I = Function;
        if (!(I instanceof Function))
          throw new TypeError(
            `new_ called with constructor type ${typeof I} which is not a function`
          );
        var B = AA(I.name || 'unknownFunctionName', () => {});
        return (
          (B.prototype = I.prototype),
          (B = new B()),
          (A = I.apply(B, A)),
          A instanceof Object ? A : B
        );
      }
      var qA = (A, I) => {
          if (Q[A].A === void 0) {
            ...
            (Q[A] = function () {
              if (!Q[A].A.hasOwnProperty(arguments.length))
                throw new f(
                  `Function '${I}' called with an invalid number of arguments (${arguments.length}) - expects one of (${Q[A].A})!`
                );
        ...
        XA = (A, I, B) => {
          if (Q.hasOwnProperty(A)) {
            ...
            if ((qA(A, A), Q.hasOwnProperty(B)))
              throw new f(
                `Cannot register multiple overloads of a function with the same number of arguments (${B})!`
              );
            Q[A].A[B] = I;
          } else (Q[A] = I), B !== void 0 && (Q[A].O = B);
        },
        PA = (A, I) => {
          for (var B = [], g = 0; g < A; g++) B.push(w[(I + 4 * g) >> 2]);
          return B;
        },
        IA,
        KA = (A, I) => {
          ...
          return () => {
            if (
              ((B.length = 0), Object.assign(B, arguments), A.includes('j'))
            ) {
              var g = Q['dynCall_' + A];
              g =
                B && B.length ? g.apply(null, [I].concat(B)) : g.call(null, I);
            } else g = IA.get(I).apply(null, B);
            return g;
          };
        },
        jA = (A, I) => {
      ...
      for (
        var RA = typeof TextDecoder < 'u' ? new TextDecoder('utf8') : void 0,
          dA = typeof TextDecoder < 'u' ? new TextDecoder('utf-16le') : void 0,
          $A = (A, I) => {
            for (var B = A >> 1, g = B + I / 2; !(B >= g) && K[B]; ) ++B;
            if (((B <<= 1), 32 < B - A && dA))
          ...
          _A = (A, I, B) => {
            ...
            for (var C = 0; C < B; ++C) (T[I >> 1] = A.charCodeAt(C)), (I += 2);
            return (T[I >> 1] = 0), I - g;
          },
          AI = A => 2 * A.length,
          II = (A, I) => {
      ...
      (hA = NA),
        ...
        (l.D = l.B.length),
        (Q.count_emval_handles = () => {
          for (var A = 0, I = l.D; I < l.B.length; ++I)
            l.B[I] !== void 0 && ++A;
          return A;
        }),
        (yA = Q.UnboundTypeError =
          ((A, I) => {
            ...
            (A = y(A)),
              ...
              MA(t, E => {
                ...
                var s = E[1] !== null && !1,
                  ...
                  u = E[0].name !== 'void';
                n = [vA, n, i, bA, E[0], E[1]];
                for (var c = 0; c < e - 2; ++c) n.push(E[c + 2]);
                if (!F)
...
`
          ...
          b: (A, I, B, g, C) => {
            if (
              ((I = y(I)), C === -1 && (C = 4294967295), (C = t => t), g === 0)
            ) {
              var i = 32 - 8 * B;
              C = t => (t << i) >>> i;
            }
            var r = I.includes('unsigned') ? (t, E) => E >>> 0 : (t, E) => E;
            N(A, {
              name: I,
              fromWireType: C,
              toWireType: r,
          ...
          f: (A, I) => {
            ...
            if (B === void 0)
              throw (
                ((A = '_emval_take_value has unknown type ' + uA(A)), new f(A))
              );
        ...
        k = (() => {
          ...
          function A(g) {
            ...
            return (
              ...
              eA.unshift(k.s),
              W--,
              (C = Q.monitorRunDependencies) == null || C.call(Q, W),
              W == 0 && q && ((g = q), (q = null), g()),
              k
            );
          }
          ...
          if (
            (W++,
            (B = Q.monitorRunDependencies) == null || B.call(Q, W),
            Q.instantiateWasm)
          )
            try {
              return Q.instantiateWasm(I, A);
            } catch (g) {
              U(`Module.instantiateWasm callback failed with error: ${g}`),
                d(g);
            }
          return (
            YA(I, g => {
      ...
      function pA() {
        function A() {
          if (!V && ((V = !0), (Q.calledRun = !0), !CA)) {
            if (
              ...
              for (
                typeof Q.postRun == 'function' && (Q.postRun = [Q.postRun]);
                Q.postRun.length;
              ) {
        ...
        if (!(0 < W)) {
          if (Q.preRun)
            for (
              typeof Q.preRun == 'function' && (Q.preRun = [Q.preRun]);
              Q.preRun.length;
            )
              WA();
          $(tA),
      ...
      if (Q.preInit)
        for (
          typeof Q.preInit == 'function' && (Q.preInit = [Q.preInit]);
          0 < Q.preInit.length;
        )
          Q.preInit.pop()();
      return pA(), J.ready;
  ...
  Z = 2113929216,
  b,
  kA = () => eI({ noInitialRun: !0, wasmBinary: oI }),
  p,
  aI =
    ((p = class {
      constructor(Q = QA) {
        ...
        if (!Number.isInteger(Q))
          throw Error(
            `Invalid acceleration "${Q}". Must be a positive integer.`
          );
      ...
      async encode(Q) {
        ...
        const D = await b,
          d = D.compress(Q, this.acceleration),
          m = new Uint8Array(d);
    ...
    L(p, 'codecId', 'lz4'),
    L(p, 'DEFAULT_ACCELERATION', QA),
    L(p, 'max_buffer_size', Z),
    p),
  DI = aI;
