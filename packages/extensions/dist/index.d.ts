import type * as _deck_gl_core from '@deck.gl/core';
...
declare const AdditiveColormapExtension: {
  new (
    ...
    getSubLayerProps(
      this: _deck_gl_core.CompositeLayer,
      extension: /*elided*/ any
    ): any;
    initializeState(
      this: _deck_gl_core.Layer,
      context: _deck_gl_core.LayerContext,
      extension: /*elided*/ any
    ): void;
...
declare const ColorPaletteExtension: {
  new (
    ...
    updateState(
      this: _deck_gl_core.Layer,
      params: _deck_gl_core.UpdateParameters<_deck_gl_core.Layer>,
      extension: /*elided*/ any
    ): void;
    onNeedsRedraw(this: _deck_gl_core.Layer, extension: /*elided*/ any): void;
    getNeedsPickingBuffer(
...
declare namespace AdditiveColormap3DExtensions {
  ...
  export {
    MaximumIntensityProjectionExtension$1 as MaximumIntensityProjectionExtension
  };
  export {
    MinimumIntensityProjectionExtension$1 as MinimumIntensityProjectionExtension
  };
}
